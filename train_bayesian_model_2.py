...
from model import BayesianModel2
...
# loading data
t_bayesian_parameters_pickle = "parameters/bayesian_model2/t.pickle"
q_bayesian_parameters_pickle = "parameters/bayesian_model2/q.pickle"
...
for i in range(epochs):
    ...
    with open('parameters/bayesian_model2/training_measures.csv', 'w') as file:
