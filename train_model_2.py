...
# loading data
t_model2_parameters_pickle = "parameters/model2-{}/t.pickle".format(initialisation_type)
q_model2_parameters_pickle = "parameters/model2-{}/q.pickle".format(initialisation_type)
...
model = Model2(data, validation_gold_alignments, initialisation_type=initialisation_type)
...
for i in range(epochs):
    ...
    perplexity = model.write_NAACL_alignments(None)
    ...
    with open('parameters/model2-{}/training_measures.csv'.format(initialisation_type), 'w') as file:
